...
class BloomzPoliticalQA:
    def __init__(self, model_name='bigscience/bloomz-560m', device='cuda:1' if torch.cuda.is_available() else 'cpu'):
        self.device = device
...
def main():
    ...
    political_qa = BloomzPoliticalQA()
    ...
    political_qa.train(
        ...
        batch_size=16,
        epochs=5,
        output_dir='political_bloomz_model'
    )
    ...
    results_df.to_csv('bloomz_results.csv', index=False)
    print(f"\nResults saved to bloomz_results.csv")
